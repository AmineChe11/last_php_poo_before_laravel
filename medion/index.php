...
<head>
  ...
  <title>Pharmacie Chekkouri</title>
...
<body>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="d-flex  flex-column flex-lg-row align-items-center w-100 justify-content-between">
              <ul class="navbar-nav  ">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="medicaments.php"> Medicine </a>
                </li>
                <li class="nav-item">
  ...
  <div class="btn_container">
    <a href="product-details.php?id=1"> <!-- Ici, 1 est l'ID du produit -->
      Buy Now
    </a>
  </div>
  <div class="img-box">
